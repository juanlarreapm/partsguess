...
// Game data - using medium difficulty as the default
const gameData = [
  {
    id: 1,
    image: "/placeholder.svg?height=300&width=400",
    correctAnswer: "Cold Air Intake",
    options: ["Cold Air Intake", "Exhaust Header", "Turbocharger", "Intercooler"],
    description: "Aftermarket system that brings cooler air into the combustion chamber for improved performance.",
  },
  {
    id: 2,
    image: "/placeholder.svg?height=300&width=400",
    correctAnswer: "Coilover Suspension",
    options: ["Coilover Suspension", "Lowering Springs", "Sway Bar", "Strut Tower Brace"],
    description: "Adjustable suspension system that allows for customization of ride height and damping.",
  },
  {
    id: 3,
    image: "/placeholder.svg?height=300&width=400",
    correctAnswer: "Performance Exhaust",
    options: ["Performance Exhaust", "Catalytic Converter", "Muffler Delete", "Resonator"],
    description: "Aftermarket exhaust system designed to reduce backpressure and increase horsepower.",
  },
  {
    id: 4,
    image: "/placeholder.svg?height=300&width=400",
    correctAnswer: "Blow-Off Valve",
    options: ["Blow-Off Valve", "Wastegate", "Boost Controller", "Diverter Valve"],
    description: "Pressure release system that vents excess boost pressure when the throttle is closed.",
  },
  {
    id: 5,
    image: "/placeholder.svg?height=300&width=400",
    correctAnswer: "Big Brake Kit",
    options: ["Big Brake Kit", "Slotted Rotors", "Brake Pads", "Caliper Covers"],
    description: "Upgraded brake system with larger calipers and rotors for improved stopping power.",
  },
]
        ...
        >
          <motion.div className="text-center">
            ...
            <motion.p className="text-xl mb-8 text-slate-300 font-light tracking-wide" variants={itemVariants}>
              Test your knowledge of aftermarket car parts!
            </motion.p>
                ...
                <motion.div variants={itemVariants}>
                  {score === gameData.length ? (
                    ...
                    <p className="text-orange-400 text-center mb-6 text-lg font-medium">
                      Good job! You know your aftermarket parts!
                    </p>
                  ) : (
                    <p className="text-slate-300 text-center mb-6 text-lg font-medium">
                      Keep learning about aftermarket parts!
                    </p>
                  )}
                </motion.div>
                <motion.div variants={itemVariants}>
          ...
          <Card className="bg-slate-800 border-slate-700 shadow-xl mb-6">
            <CardContent className="p-6">
              ...
              <motion.h2
                ...
                variants={itemVariants}
              >
                What aftermarket car part is this?
              </motion.h2>
